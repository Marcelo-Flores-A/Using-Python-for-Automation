...
result = pyip.inputInt("Enter the number of shopping bags you will need for your items:", min=0) # This asks the user to enter the number of bags an checks that it is an integer and it's equal or greater than 0 
